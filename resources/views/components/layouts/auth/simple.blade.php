    ...
    <body class="min-h-screen antialiased" style="background: linear-gradient(135deg, #A6128D 0%, #8C0375 100%);">
        <div class="flex min-h-svh flex-col items-center justify-center gap-8 p-6 md:p-10">
            <div class="flex w-full max-w-md flex-col gap-5">
                <a href="{{ route('home') }}" class="flex flex-col items-center justify-center text-center text-white" wire:navigate>
                    ...
                    <span class="mt-3 text-xl font-bold tracking-[0.2em] uppercase text-white">SOHMC</span>
