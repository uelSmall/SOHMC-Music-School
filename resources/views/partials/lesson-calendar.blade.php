...
<section class="soh-card p-6">
    ...
    <div class="js-lesson-calendar-wrapper" data-events-url="{{ $eventsUrl }}" data-viewer-role="{{ $viewerRole }}">
        <div class="js-lesson-calendar-content {{ $collapsed ? 'hidden' : '' }}">
            ...
            <div class="js-lesson-calendar-modal fixed inset-0 z-50 hidden items-center justify-center bg-black/50 p-4">
                <div class="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
                    <div class="mb-4 flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-black">Lesson Details</h3>
                        <button type="button" class="js-close-lesson-calendar-modal rounded-md px-2 py-1 text-sm text-gray-500 hover:bg-gray-100">Close</button>
                    </div>
