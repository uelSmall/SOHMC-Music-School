        ...
        <div class="flex flex-col gap-3">
            ...
            <div>
                ...
                <p class="soh-page-subtitle">
                    @if($role === 'teacher')
                        Review the lesson and manage its lifecycle.
                    @elseif($role === 'admin')
                        Booking details for this scheduled lesson.
                    @else
                        View your scheduled lesson details.
                    @endif
                </p>
            </div>
        </div>
            ...
            <section class="space-y-6">
                @if($role === 'teacher' || $role === 'admin')
                    <article class="soh-card p-6">
                        ...
                        <form method="POST" action="{{ route('bookings.complete', $lesson) }}" class="mt-4">
                            @csrf
                            @method('PATCH')
                    ...
                    <article class="soh-card p-6">
                        ...
                        <form method="POST" action="{{ route('bookings.reschedule-lesson', $lesson) }}" class="mt-4 space-y-3">
                            @csrf
                            @method('PATCH')
                            <div>
                    ...
                    <article class="soh-card p-6">
                        ...
                        <form method="POST" action="{{ route('bookings.cancel', $lesson) }}" class="mt-4 space-y-3">
                            @csrf
                            @method('PATCH')
                            <div>
