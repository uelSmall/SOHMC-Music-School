<div>
    ...
    <div class="soh-card overflow-hidden">
        <div class="border-b border-gray-100">
            <nav class="flex gap-1 px-1 pt-1 overflow-x-auto" aria-label="Tabs">
                @foreach($tabs as $tab)
                    <button wire:click="setTab('{{ $tab['key'] }}')"
                            class="group relative flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium transition whitespace-nowrap
                                   {{ $activeTab === $tab['key']
        ...
        <div class="border-b border-gray-100 px-6 py-3">
            <div class="relative max-w-sm">
                ...
                <input type="text" wire:model.live.debounce.300ms="searchTerm" placeholder="Search by name or email..."
        ...
        {{-- Table --}}
        <div class="overflow-x-auto" wire:loading.class="opacity-50" wire:loading.class.delay="opacity-100">
